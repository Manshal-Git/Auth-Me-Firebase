...
import com.manshal_khatri.authmefirebase.databinding.FragmentResetPasswordBinding
...
import com.manshal_khatri.authmefirebase.util.GenericTextWatcher
import com.manshal_khatri.authmefirebase.util.GetInput
...
class ResetPasswordFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        dd = d.loadingScreen()
         ...
         edit = arrayOf<EditText>(otp_textbox_one, otp_textbox_two, otp_textbox_three, otp_textbox_four)
...
//                Log.d(TAG, "$email $otp $newpass")
                // todo send Otp verification req to server
